  ...
  return (
    <Link href={href} className="elegant-card card-shine group block">
      <div className="relative h-52 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-jaguar-black via-jaguar-black/30 to-transparent" />
        <div className="absolute bottom-0 left-0 right-0 p-6">
          <h3 className="text-lg font-semibold text-white group-hover:text-jaguar-gold-bright">
            {title}
          </h3>
        </div>
      </div>
