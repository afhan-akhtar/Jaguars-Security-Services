  ...
  return (
    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute bottom-5 left-5 icon-ring-solid h-12 w-12">
          <Icon className="h-5 w-5 text-jaguar-black" />
        </div>
      </div>

      <div className="flex flex-1 flex-col p-7">
        <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-semibold text-jaguar-black transition-colors group-hover:text-jaguar-gold-bright">
          {category.title}
        </h3>
